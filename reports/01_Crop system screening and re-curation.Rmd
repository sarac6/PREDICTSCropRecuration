...
File: Blocks_to_check_for_crops.csv https://naturalhistorymuseum.sharepoint.com/sites/PurvisLab-PREDICTSforbusiness/Shared Documents/PREDICTS for business/Blocks_to_check_for_crops.csv


Each block that need to be checked will hava a row per Predominant Habitat call (so if a block has Cropland and Plantation forest, it will have two rows). 
...
to check and priority will be given to the ones that have a baseline site